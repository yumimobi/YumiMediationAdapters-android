...
public class GdtmobNativeHolder {
    ...
    public void initNativeUnifiedAD(Activity mActivity, String key2, NativeADUnifiedListener unifiedListener) {
        nativeAD = new NativeUnifiedAD(mActivity, key2, unifiedListener);
    }
    ...
    public void initNativeExpressAD(Activity mActivity, String key2, YumiNativeAdOptions nativeAdOptions, NativeExpressADListener expressADListeners) {
        nativeExpressAD = new NativeExpressAD(mActivity, new ADSize(nativeAdOptions.getExpressAdSize().getWidth(), nativeAdOptions.getExpressAdSize().getHeight()), key2, expressADListeners); // 传入Activity
